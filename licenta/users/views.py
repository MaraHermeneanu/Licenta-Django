...
@login_required
def camera_calibration(request):
...
@login_required
def delete_camera_config(request): ##TODO error handling here 
    if request.method == 'POST':
...
@login_required
def stereo_calibration(request): ##TODO
    if request.method == 'POST':
...
@login_required
def delete_stereo_config(request): ##TODO error handling here 
    if request.method == 'POST':
        title = request.POST.get('select')
